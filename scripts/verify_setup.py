...
REQUIRED_PATHS = [
    ...
    "scripts/compare_corpus_sizes.py",
    ...
    "iterations/001_retrieval_baseline/failures.csv",
    "iterations/001_retrieval_baseline/data_profile.md",
    "iterations/001_retrieval_baseline/CORPUS_COMPARISON.md",
    "iterations/001_retrieval_baseline/corpus_comparison.json",
    ...
    "tests/fixtures/ingestion_ground_truth.json",
    "iterations/002_ingestion_baseline/BRIEF.md",
    "iterations/002_ingestion_baseline/RULES.md",
    "iterations/002_ingestion_baseline/CANONICAL_SCHEMA.md",
    "iterations/002_ingestion_baseline/RESULT.md",
    "iterations/002_ingestion_baseline/parse_report.json",
    "iterations/002_ingestion_baseline/failures.csv",
    "iterations/002_ingestion_baseline/inspection.html",
